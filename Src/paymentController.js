...
export const paymentController = async (req, res) => {
    try {
        ...
        const data = {
                ...
                currency: 'BDT',
                tran_id: tran_id,
                success_url: `https://paymentsystemforinfraredbackend.onrender.com/api/success`,
                fail_url: `https://paymentsystemforinfraredbackend.onrender.com/api/failed`,
                cancel_url: `https://paymentsystemforinfraredbackend.onrender.com/api/cancel`,
